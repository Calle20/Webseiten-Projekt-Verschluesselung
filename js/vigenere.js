	function doCrypt(isDecrypt){
        ...
        var output;
        if(isDecrypt){
            keyStr = document.getElementById("keyde").value;
            textElem = document.getElementById("vinboxde");
            output=document.getElementById("vinoutputde");
        }
        else{
            keyStr = document.getElementById("keyen").value;
            textElem = document.getElementById("vinboxen");
            output=document.getElementById("vinoutputen");
        }
		if (keyStr.length == 0) {
			alert("Key is empty");
			return;
		...
		output.value = crypt(textElem.value, keyArray);
	};
